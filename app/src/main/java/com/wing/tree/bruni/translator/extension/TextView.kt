...
private val TextView.extraExtraLargeTextSize: Float get() = resources.dimen(R.dimen.extra_extra_large_text_size)
...
private val TextView.extraExtraSmallTextSize: Float get() = resources.dimen(R.dimen.extra_extra_small_text_size)

internal fun TextView.resizeText(): Float {
    val scaledDensity = resources.displayMetrics.scaledDensity

    return when {
        lineCount(extraExtraLargeTextSize) <= EXTRA_EXTRA_LARGE_TEXT_MAX_LINES -> extraExtraLargeTextSize
        ...
        lineCount(extraSmallTextSize) <= EXTRA_SMALL_TEXT_MAX_LINES -> extraSmallTextSize
        else -> extraExtraSmallTextSize
    }
        .div(scaledDensity)
        .also {
            textSize = it
